...
const getFormElement = (event: HTMLFormElement ) => (elementName: string) => {
...
function createImage (data: HTMLImageElement): HTMLTableCellElement {
...
function createText (value: string): HTMLTableCellElement {
  const td = document.createElement('td')
  td.textContent = value
  return td
}

function createColor (value: string): HTMLTableCellElement {
  const td = document.createElement('td')
